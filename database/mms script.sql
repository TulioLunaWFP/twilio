...
CREATE TABLE `customers` (
  ...
  `CellularPhone` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `customers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1820;
--
-- AUTO_INCREMENT for table `customers3`
--
ALTER TABLE `customers3`
